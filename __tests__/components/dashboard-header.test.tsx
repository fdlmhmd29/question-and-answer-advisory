...
// Mock next/link
jest.mock('next/link', () => {
  return ({ children, href, as, replace, scroll, shallow, passHref, prefetch, locale, legacyBehavior, isOnest, ...props }: any) => {
    return (
      <a
        href={href}
        onClick={(e) => {
          e.preventDefault()
          // If there's an onClick handler passed down, call it
